!(function (e, t) {
  ...
  function g(e) {
    ...
    return (
      "pages" in e && (t += ", pp. " + e.pages), "" != t && (t += ". "), "publisher" in e && "." != (t += e.publisher)[t.length - 1] && (t += "."), t
    );
  }
  function v(e) {
    if ("url" in e) {
      ...
      .map(
        (e) =>
          `\n        <p class="author">\n          ${
            ...
            .map((e) => (e.url ? `<a class="affiliation" href="${e.url}">${e.name}</a>` : `<span class="affiliation">${e.name}</span>`))
            .join(", ")}\n        </p>\n      `
      )
      .join("")}\n    </div>\n    <div>\n      <h3>Published</h3>\n      ${
  ...
  function $(e) {
    ...
    return (
      ...
      void 0 !== e.publishedDate &&
        ...
        }, "${e.title}", Distill, ${e.publishedYear}.</pre>\n    <p>BibTeX citation</p>\n    <pre class="citation long">${d(e)}</pre>\n    `),
      t
    );
  }
  // Copyright 2018 The Distill Template Authors
  ...
  const K = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
    ...
    X = (e) => (e < 10 ? "0" + e : e),
    Z = function (e) {
      return `${K[e.getDay()].substring(0, 3)}, ${X(e.getDate())} ${J[e.getMonth()].substring(0, 3)} ${e.getFullYear().toString()} ${e
        .getUTCHours()
        .toString()}:${e.getUTCMinutes().toString()}:${e.getUTCSeconds().toString()} Z`;
    },
    Q = function (e) {
              ...
              function (e, t) {
                ...
                var i = n(e("babel-runtime/core-js/json/stringify")),
                  ...
                  A = function (e, t, n) {
                    ...
                    return (
                      (r.height = n || t.fontMetrics().defaultRuleThickness), (r.style.borderBottomWidth = r.height + "em"), (r.maxFontSize = 1), r
                    );
                  };
              ...
              function (e, t) {
                ...
                i(["array", "darray"], { numArgs: 1 }, function (e, t) {
                  ...
                  i(["matrix", "pmatrix", "bmatrix", "Bmatrix", "vmatrix", "Vmatrix"], {}, function (e) {
                    ...
                    return (
                      (n = r(e.parser, n, a(e.envName))), t && (n = new o.default("leftright", { body: [n], left: t[0], right: t[1] }, e.mode)), n
                    );
                  }),
      ...
      for (let e = 0; e < n.length; e++)
        if ("text" === n[e].type) r.appendChild(document.createTextNode(n[e].data));
          ...
          try {
            ...
            t.errorCallback("KaTeX auto-render: Failed to parse `" + n[e].data + "` with ", i), r.appendChild(document.createTextNode(n[e].rawData));
            continue;
          }
          r.appendChild(i);
        }
