...
const siteUrl = "https://lpyhdzx.github.io"; 
let updatedUrl = currentUrl.replace("https://lpyhdzx.github.io/multi-language-al-folio", "");
      ...
      window.location.href = "/multi-language-al-folio/";
        ...
        handler: () => {
          ...
          section: "",handler: () => {
            ...
            },},{id: "news-one-paper-is-accepted-by-emnlp-2025-tada-tada",
          title: 'One paper is accepted by EMNLP 2025! :tada: :tada:',
          description: "",
          section: "News",},{id: "news-released-squrve-an-open-source-project-for-text-to-sql-rocket",
          title: 'Released Squrve, an open-source project for Text-to-SQL. :rocket:',
          description: "",
          section: "News",},{id: "news-honored-to-be-invited-to-deliver-a-talk-at-chinamm-titled-towards-the-democratization-of-ai-compression-and-efficient-inference-of-large-language-models",
          title: 'Honored to be invited to deliver a talk at ChinaMM, titled ‘Towards the...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6C%69%75%70%65%69%79%75%73%74%75@%31%36%33.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/lpyhdzx", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=0UyGs0YAAAAJ", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://it.uibe.edu.cn/szdw/dsjkxyjzx/2e6af159ce2b4ca68fdaad5c932fd43c.htm", "_blank");
        },
      },{
      id: 'light-theme',
